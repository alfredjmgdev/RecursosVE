...
export class UserInMemoryRepository implements UserRepositoryPort {
  private readonly users: User[] = [
    ...
    new User('usr_trans_4', 'transportista@recursosve.org', 'Carlos Mendoza (Chofer 4x4)', UserRole.TRANSPORTISTA),
    new User('usr_trans_4_alt', 'transportista@recursos.ve', 'Carlos Mendoza (Chofer 4x4)', UserRole.TRANSPORTISTA),
  ];
